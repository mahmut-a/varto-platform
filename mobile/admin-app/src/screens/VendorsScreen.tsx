...
const emptyForm = { name: "", slug: "", phone: "", address: "", iban: "", category: "restaurant" }
...
export default function VendorsScreen() {
    ...
    const openEdit = (v: any) => {
        setEditing(v)
        setForm({ name: v.name, slug: v.slug || "", phone: v.phone || "", address: v.address || "", iban: v.iban || "", category: v.category || "restaurant" })
        setModalVisible(true)
    }
