...
export async function savePushTokenToBackend(courierId: string, pushToken: string) {
    try {
        await api.post(`/admin/couriers/${courierId}/push-token`, {
...
export async function removePushTokenFromBackend(courierId: string) {
    try {
        await api.delete(`/admin/couriers/${courierId}/push-token`)
